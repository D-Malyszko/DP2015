 ...
 */
package nativeswing.components.core;
...
import nativeswing.NativeComponent;
import nativeswing.components.Credentials;
import nativeswing.components.JWebBrowser;
import nativeswing.components.JWebBrowserWindow;
import nativeswing.components.WebBrowserAuthenticationHandler;
import nativeswing.components.WebBrowserCommandEvent;
import nativeswing.components.WebBrowserEvent;
import nativeswing.components.WebBrowserFunction;
import nativeswing.components.WebBrowserListener;
import nativeswing.components.WebBrowserNavigationEvent;
import nativeswing.components.WebBrowserNavigationParameters;
import nativeswing.components.WebBrowserWindowFactory;
import nativeswing.components.WebBrowserWindowOpeningEvent;
import nativeswing.components.WebBrowserWindowWillOpenEvent;
import nativeswing.components.internal.INativeWebBrowser;
import nativeswing.core.ControlCommandMessage;
import nativeswing.core.SWTNativeComponent;
    ...
    public Object run(Object[] args) {
      ...
      for(int i=listeners.length-2; i>=0; i-=2) {
        if(listeners[i] == WebBrowserListener.class) {
          ...
          if(!isInternal || webBrowserListener.getClass().getName().startsWith("")) {
