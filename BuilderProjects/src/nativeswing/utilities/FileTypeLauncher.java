...
import nativeswing.utilities.internal.INativeFileTypeLauncher;
import nativeswing.utilities.internal.INativeFileTypeLauncherStatic;
...
public class FileTypeLauncher {
  ...
  private static INativeFileTypeLauncherStatic fileTypeLauncherStatic = NativeCoreObjectFactory.create(INativeFileTypeLauncherStatic.class, "nativeswing.utilities.core.NativeFileTypeLauncherStatic", new Class<?>[0], new Object[0]);
  private INativeFileTypeLauncher fileTypeLauncher;

  public FileTypeLauncher() {
    this(NativeCoreObjectFactory.create(INativeFileTypeLauncher.class, "nativeswing.utilities.core.NativeFileTypeLauncher", new Class<?>[0], new Object[0]));
  }
