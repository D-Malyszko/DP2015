...
public class JFileDialog {
  ...
  private INativeFileDialog nativeFileDialog = NativeCoreObjectFactory.create(INativeFileDialog.class, "nativeswing.components.core.NativeFileDialog", new Class<?>[0], new Object[0]);
