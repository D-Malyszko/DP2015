 ...
 */
package nativeswing.components.win32;
...
import nativeswing.components.win32.internal.INativeWShellExplorer;
...
public class JWShellExplorer extends NSPanelComponent {
  ...
  public JWShellExplorer(NSOption... options) {
    nativeComponent = NativeCoreObjectFactory.create(INativeWShellExplorer.class, "nativeswing.components.win32.core.NativeWShellExplorer", new Class<?>[] {JWShellExplorer.class}, new Object[] {this});
