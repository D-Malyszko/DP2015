...
import nativeswing.components.internal.INativeDirectoryDialog;
...
public class JDirectoryDialog {
  ...
  private INativeDirectoryDialog nativeDirectoryDialog = NativeCoreObjectFactory.create(INativeDirectoryDialog.class, "nativeswing.components.core.NativeDirectoryDialog", new Class<?>[0], new Object[0]);
