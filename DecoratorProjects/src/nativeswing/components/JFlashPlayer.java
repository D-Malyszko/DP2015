...
import nativeswing.common.WebServer.HTTPRequest;
import nativeswing.common.WebServer.WebServerContent;
import nativeswing.common.WebServer.WebServerContentProvider;
import nativeswing.NSOption;
import nativeswing.NSSystemProperty;
import nativeswing.NSPanelComponent;
import nativeswing.WebBrowserObject;
    ...
    webBrowser.addWebBrowserListener(new WebBrowserAdapter() {
      ...
      public void commandReceived(WebBrowserCommandEvent e) {
        ...
        for(FlashPlayerListener listener: getFlashPlayerListeners()) {
          if(!isInternal || listener.getClass().getName().startsWith("")) {
            if(ev == null) {
