...
import nativeswing.components.win32.internal.INativeWMediaPlayer;
...
public class JWMediaPlayer extends NSPanelComponent {
  ...
  public JWMediaPlayer(NSOption... options) {
    nativeComponent = NativeCoreObjectFactory.create(INativeWMediaPlayer.class, "nativeswing.components.win32.core.NativeWMediaPlayer", new Class<?>[0], new Object[0]);
