 ...
 */
package nativeswing.demo;

import java.util.ArrayList;
import java.util.List;

import nativeswing.demo.examples.additionalfeatures.ComponentLifeCycle;
import nativeswing.demo.examples.additionalfeatures.ConstrainVisibility;
import nativeswing.demo.examples.additionalfeatures.DeferredDestruction;
import nativeswing.demo.examples.additionalfeatures.HierarchyProxying;
import nativeswing.demo.examples.additionalfeatures.InputEventsExample;
import nativeswing.demo.examples.additionalfeatures.PseudoTransparency;
import nativeswing.demo.examples.additionalfeatures.ThumbnailCreation;
import nativeswing.demo.examples.flashplayer.FunctionCalls;
import nativeswing.demo.examples.flashplayer.SimpleFlashExample;
import nativeswing.demo.examples.flashplayer.VariablesAndFlow;
import nativeswing.demo.examples.htmleditor.CKEditorExample;
import nativeswing.demo.examples.htmleditor.EditorDirtyExample;
import nativeswing.demo.examples.htmleditor.FCKEditorExample;
import nativeswing.demo.examples.htmleditor.TinyMCEExample;
import nativeswing.demo.examples.introduction.Codewise;
import nativeswing.demo.examples.introduction.NativeIntegration;
import nativeswing.demo.examples.introduction.TheSolution;
import nativeswing.demo.examples.introduction.WebStartAndApplets;
import nativeswing.demo.examples.nativedialogs.NativeDialogs;
import nativeswing.demo.examples.syntaxhighlighter.SimpleSyntaxHighlighterExample;
import nativeswing.demo.examples.utilities.FileAssociations;
import nativeswing.demo.examples.vlcplayer.OptionsAndPlaylistExample;
import nativeswing.demo.examples.vlcplayer.SimpleVLCPlayerExample;
import nativeswing.demo.examples.webbrowser.ClasspathPages;
import nativeswing.demo.examples.webbrowser.ConfirmedDisposal;
import nativeswing.demo.examples.webbrowser.Cookies;
import nativeswing.demo.examples.webbrowser.CustomDecorators;
import nativeswing.demo.examples.webbrowser.FullPageCaptureExample;
import nativeswing.demo.examples.webbrowser.JavascriptExecution;
import nativeswing.demo.examples.webbrowser.NavigationControl;
import nativeswing.demo.examples.webbrowser.NavigationParameters;
import nativeswing.demo.examples.webbrowser.SendingCommands;
import nativeswing.demo.examples.webbrowser.SettingContent;
import nativeswing.demo.examples.webbrowser.SimpleWebBrowserExample;
import nativeswing.demo.examples.webbrowser.WebBrowserFunctionsExample;
import nativeswing.demo.examples.webbrowser.WindowsAsTabs;
import nativeswing.demo.examples.webbrowser.XPCOMDownloadManager;
import nativeswing.demo.examples.webbrowser.XPCOMToggleEditionMode;
import nativeswing.demo.examples.win32.multimediaplayer.SimpleWMediaPlayerExample;
import nativeswing.demo.examples.win32.shellexplorer.SimpleWShellExplorerExample;
