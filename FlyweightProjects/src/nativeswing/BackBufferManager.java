...
class BackBufferManager {
  ...
  protected Rectangle[] getTranslucentOverlays() {
    ...
    boundsArea = nativeswing.common.UIUtils.subtract(boundsArea, nativeswing.common.UIUtils.getComponentVisibleArea(paintingComponent, new Filter<Component>() {
    ...
    return nativeswing.common.UIUtils.subtract(boundsArea, nativeswing.common.UIUtils.getComponentVisibleArea(paintingComponent, new Filter<Component>() {
      public Acceptance accept(Component c) {
        if(!c.isOpaque()) {
          return Acceptance.YES;
        }
  ...
  public void updateBackBuffer(Rectangle[] rectangles) {
    ...
    if(paintingComponent != nativeComponent.getNativeComponent()) {
      Rectangle bounds = nativeswing.common.UIUtils.getBounds(rectangles);
