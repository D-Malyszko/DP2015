...
import nativeswing.EventDispatchUtils;
import nativeswing.NSPanelComponent;
import nativeswing.NativeComponent;
import nativeswing.components.internal.INativeWebBrowser;
import nativeswing.components.internal.INativeWebBrowserStatic;
import nativeswing.internal.NativeCoreObjectFactory;
...
public class JWebBrowser extends NSPanelComponent {
  ...
  private static INativeWebBrowserStatic webBrowserStatic = NativeCoreObjectFactory.create(INativeWebBrowserStatic.class, "nativeswing.components.core.NativeWebBrowserStatic", new Class<?>[0], new Object[0]);
  ...
  public JWebBrowser(NSOption... options) {
    ...
    nativeWebBrowser = NativeCoreObjectFactory.create(INativeWebBrowser.class, "nativeswing.components.core.NativeWebBrowser", new Class<?>[] {JWebBrowser.class, INativeWebBrowser.WebBrowserRuntime.class}, new Object[] {this, runtime});
