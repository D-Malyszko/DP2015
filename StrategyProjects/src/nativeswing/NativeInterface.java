...
public abstract class NativeInterface {
  ...
  private static ISWTNativeInterface swtNativeInterface = NativeCoreObjectFactory.create(ISWTNativeInterface.class, "nativeswing.core.SWTNativeInterface", new Class<?>[0], new Object[0]);
