...
import nativeswing.common.Filter.Acceptance;
        ...
        if(c.isVisible()) {
          switch(filter.accept(c)) {
            case YES: {
              ...
              shape = nativeswing.common.UIUtils.subtract(shape, tempRectangle);
              break;
            }
            case TEST_CHILDREN: {
    ...
    for(int i=0; i<children.length; i++) {
      ...
      if(child.isVisible()) {
        ...
        if(accept == Acceptance.YES) {
          ...
          shape = nativeswing.common.UIUtils.subtract(shape, SwingUtilities.convertRectangle(parent, tempRectangle, component));
