...
import nativeswing.components.internal.INativeMozillaXPCOM;
...
public class MozillaXPCOM {
  ...
  private static INativeMozillaXPCOM nativeMozillaXPCOM = NativeCoreObjectFactory.create(INativeMozillaXPCOM.class, "nativeswing.components.core.NativeMozillaXPCOM", new Class<?>[0], new Object[0]);
